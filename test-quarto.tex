...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, breakable, enhanced, borderline west={3pt}{0pt}{shadecolor}, interior hidden, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics{test-quarto_files/figure-pdf/unnamed-chunk-8-1.pdf}
...
{\centering \includegraphics{test-quarto_files/figure-pdf/unnamed-chunk-10-1.pdf}
